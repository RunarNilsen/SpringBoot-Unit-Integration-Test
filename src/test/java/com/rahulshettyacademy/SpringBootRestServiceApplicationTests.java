...
@SpringBootTest
@AutoConfigureMockMvc    // enable testing without the cost of starting the server

class SpringBootRestServiceApplicationTests {
	/*
	- Test methods in the services
	 */
	@Autowired      // use for dependency injection
	LibraryController con;
	@MockBean
	LibraryRepository repository;
	@MockBean      // helps mocking the dependencies that are used in Controller Classes
	...
	{
		//mock
		// LibraryService needs an argument which type is Library, so we have to create it here by manuel
		// that's why we create buildLibrary() method
		// we can also use    Library lib = new Library(.......)
		...
		ResponseEntity response	=con.addBookImplementation(lib);//step
	...
	/*
	Class ObjectMapper. ObjectMapper provides functionality for reading and writing JSON, either to and from basic POJOs (Plain Old Java Objects),
	...
	public void addBookControllerTest() throws Exception
	{
		...
		String jsonString = map.writeValueAsString(lib); // convert Class to Json String
