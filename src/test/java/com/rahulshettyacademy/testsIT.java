...
public class testsIT {
	...
	We have server running to do integration-testing.
	In integration test we have to communicate the REST API, so we cannnot MOCK the services
	 */
	//mvn test
	//TestRestTemplate or Rest Assured is used to communicate REST API here.
	// TestRestTemplate is good for writing integration test in Spring Boot
	@Test
	public void getAuthorNameBooksTest() throws JSONException
	{
		String expected= "[\r\n" + 
				...
				"    }\r\n" + 
				"]";
		//String exp2 = "[{\"book_name\":\"Appium\",\"id\":\"fdsefr343\",\"isbn\":\"fdsefr3\",\"aisle\":43,\"author\":\"Cemal\"}]";
	...
	public void addBookIntegrationTest()
	{
		...
		HttpEntity<Library> request = new HttpEntity<Library>(buildLibrary(),headers); // create the response
